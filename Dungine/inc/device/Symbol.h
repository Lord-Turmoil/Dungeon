...
public:
    Symbol()
        : m_pSupSymbol(nullptr), m_pSubSymbol(nullptr), m_pAttribute(nullptr), m_pImage(nullptr), m_layer(LAYER_NORMAL),
          m_isStatic(false)
    {
    }
