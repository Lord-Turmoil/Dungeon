...
private:
	...
	IMAGE* GetFrame(int frame) { return &m_frame[frame]; }
...
public:
	Motion() : m_frameNum(0), m_frameSpeed(0), m_isLoop(false) {}
	Motion(
		XMLElement* node,
		IMAGE* pImage,
		int frameWidth,
...
private:
	...
	IMAGE* GetFrame(int frame, AnimDirection dir = (AnimDirection)(0));

	int GetFrameNum() const { return m_frameNum; }
	clock_t GetFrameSpeed() const { return m_frameSpeed; }
...
public:
	...
	void SetFrame(int frame) { m_curFrame = frame; }	// deprecated
