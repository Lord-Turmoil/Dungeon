...
public:
    ...
    GameObject* Clone() const override = 0;
...
public:
    ...
    */
    ...
    virtual void SetCenter(const Coordinate& center)
    {
        m_coord = center;
    }
...
public:
    ...
    void SetDisplay(bool isToDisplay)
    {
        m_isToDisplay = isToDisplay;
    }
    ...
    bool IsToDisplay() const
    {
        return m_isToDisplay;
    }
