...
public:
    ...
    */
    bool Instant(int vKey) const
    {
        return m_instantKey[vKey];
    }

    bool Sluggish(int vKey) const
    {
        return m_sluggishKey[vKey];
    }

    bool InstantCtrl(int vKey) const
    {
        return m_instantKey[VK_CONTROL] && m_instantKey[vKey];
    }

    bool SluggishCtrl(int vKey) const
    {
        return m_instantKey[VK_CONTROL] && m_sluggishKey[vKey];
    }

    const Coordinate& Mouse() const
    {
        return m_mouse;
    }
