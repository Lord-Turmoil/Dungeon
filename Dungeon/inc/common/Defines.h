...
const CollisionType COLLISION_MAP[COLL_ID_NUM][COLL_ID_NUM] = {
	...
	{ COLL_NONE,	COLL_INELASTIC,	COLL_NONE,		COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_ELASTIC,	COLL_NONE,	COLL_ELASTIC	},
	{ COLL_NONE,	COLL_INELASTIC,	COLL_NONE,		COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_NONE,		COLL_NONE,	COLL_NONE		},
	{ COLL_NONE,	COLL_INELASTIC,	COLL_INELASTIC,	COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_NONE,	COLL_ELASTIC,	COLL_NONE,	COLL_ELASTIC	} };
