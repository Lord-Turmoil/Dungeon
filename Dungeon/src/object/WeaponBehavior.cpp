...
void WeaponBehavior::_Fire()
{
    ...
    Bullet* proto = BulletLibrary::GetInstance()->GetBulletByName(weapon->BulletName());
    Bullet* bullet;
...
void WeaponFire::OnEnter()
{
    ...
    weapon->GetComponent<AnimComponent>()->GetAnim()->SetMotion(WEAPON_ANIM_FIRE);
...
void WeaponCooling::OnEnter()
{
    ...
    weapon->GetComponent<AnimComponent>()->GetAnim()->SetMotion(WEAPON_ANIM_COOLING);
