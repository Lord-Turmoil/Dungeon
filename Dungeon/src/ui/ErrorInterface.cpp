...
bool ErrorInterface::Load(XMLElement* node)
{
	...
	*/
	...
	center.Init(deviceInfo.clientWidth / 2, (int)(deviceInfo.clientHeight * 0.2));
	prompt->SetCoord(center)->SetSize(size.x, size.y)
		->SetFocus(size.x / 2, size.y / 2);
	prompt->SetFontSize(50)->SetFontColor(RGB(183, 28, 28))->SetFontFace("Fixedsys")
		->SetText("Fatal Error :(");
	...
	prompt->SetCoord(center)->SetSize(size.x, size.y)
		->SetFocus(size.x / 2, size.y / 2);
	prompt->SetFontSize(20)->SetFontColor(RGB(183, 28, 28))->SetFontFace("Fixedsys")
	...
	*/
	...
	center.Init(deviceInfo.clientWidth / 2, (int)(deviceInfo.clientHeight * 0.7));

	// up
	rect = new RectDrawer();
	rect->SetCoord(center)->SetSize(100, 60)->SetFocus(54, 34);
	rect->Filled(true)->SetFillColor(RGB(100, 221, 23))
		->SetLineThickness(8)->SetLineColor(RGB(70, 154, 16));
	text = new TextDrawer();
	text->SetCoord(center)->SetSize(100, 60)->SetFocus(50, 30);
	text->SetText("Exit")->SetFontSize(40)->SetFontFace("Fixedsys")
		->SetFontColor(BLACK);
	...
	rect = new RectDrawer();
	rect->SetCoord(center)->SetSize(100, 60)->SetFocus(54, 34);
	rect->Filled(true)->SetFillColor(RGB(118, 255, 3))
		->SetLineThickness(8)->SetLineColor(RGB(70, 154, 16));
	text = new TextDrawer();
	text->SetCoord(center)->SetSize(100, 60)->SetFocus(50, 30);
	text->SetText("Exit")->SetFontSize(40)->SetFontFace("Fixedsys")
	...
	rect = new RectDrawer();
	rect->SetCoord(center)->SetSize(100, 60)->SetFocus(54, 34);
	rect->Filled(true)->SetFillColor(RGB(82, 178, 2))
		->SetLineThickness(8)->SetLineColor(RGB(70, 154, 16));
	text = new TextDrawer();
	text->SetCoord(center)->SetSize(100, 60)->SetFocus(50, 30);
	text->SetText("Exit")->SetFontSize(40)->SetFontFace("Fixedsys")
...
{
	static_cast<Button*>((*m_pWidgetManager)["quit"])
