...
void GameInterface::Update(Event* evnt)
{
	...
	if (m_pDungeon)
	{
		...
		_UpdateStatus(
			static_cast<ProgressBar*>(m_pWidgetManager->GetWidget("hp")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("hp-tip")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("hp-alert")),
			hero->GetHP(),
			hero->GetMaxHP());
		_UpdateStatus(
			static_cast<ProgressBar*>(m_pWidgetManager->GetWidget("mp")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("mp-tip")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("mp-alert")),
			hero->GetMP(),
			hero->GetMaxMP());
		_UpdateStatus(
			static_cast<ProgressBar*>(m_pWidgetManager->GetWidget("armor")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("armor-tip")),
			static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("armor-alert")),
			hero->GetArmor(),
			hero->GetMaxArmor());
		_UpdateChiStatus(
			static_cast<ProgressBar*>(m_pWidgetManager->GetWidget("chi")),
...
{
	static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("b-level"))
		->ResetTransition()->StopTransition();
	static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("b-complete"))
		->ResetTransition()->StopTransition();
	static_cast<StaticWidget*>(m_pWidgetManager->GetWidget("b-final"))
		->ResetTransition()->StopTransition();
